...
// Pines del joystick
//#define VRX_1 A0    // Joystick 1 X
//#define VRY_2 A1    // Joystick 2 Y

#define up     5 // Botón adelante
#define right 4 // Botón derecha
#define down   3 // Botón abajo
#define left  2 // Botón izquierda
