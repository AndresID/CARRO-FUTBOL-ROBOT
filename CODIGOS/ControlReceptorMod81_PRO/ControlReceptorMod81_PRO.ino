...
void loop() {
  if (radio.available()) {
    ...
    if(datosControl.program ==0){
      ...
      // Control en ejeX_1 del joystick
      ...
      if (datosControl.accservo == true) {
        ...
        miServo.write(-20);  // Mueve el servo a la posición neutral (0 grados)
      } 
    ...
    if(datosControl.program == 1){
      ...
      if (datosControl.downy == true){ //Derecha
        digitalWrite(IN1, HIGH);
        digitalWrite(IN2, LOW);
        digitalWrite(IN3, LOW);
        digitalWrite(IN4, HIGH);
      ...
      else if (datosControl.upy == true) { //Izquierda
        digitalWrite(IN1, HIGH);
        digitalWrite(IN2, LOW);
        digitalWrite(IN3, HIGH);
        digitalWrite(IN4, LOW);
